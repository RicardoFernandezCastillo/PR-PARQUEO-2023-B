    ...
    try {
      ...
      if (requestDoc.exists) {
        ...
        setState(() {
          ...
          apellidoController.text = data[AccountRequestCollection.apellidos];
...
Future<void> setEnabledRequest(String idRequest) async {
  try {
    ...
    await FirebaseFirestore.instance
      ...
      UsersCollection.apellidos: datos[UsersCollection.apellidos],
      UsersCollection.telefono: datos[UsersCollection.telefono],
      UsersCollection.correo: datos[UsersCollection.correo],
      UsersCollection.genero: datos[UsersCollection.genero],
